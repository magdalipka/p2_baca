...
void Move_M (int killed, char Killed1, char Killed2, char Killed3, char Born1, char Born2, char Born3) {
	...
	if ( findsznur(Born1, Born2, Born3) != NULL ) {
		...
		(*findkoralik(killed, Born1, Born2, Born3)).first_outgoing = (*findkoralik(killed, Killed1, Killed2, Killed3)).first_outgoing;
		(*findkoralik(killed, Killed1, Killed2, Killed3)).first_outgoing = NULL;

		//skopiowanie polaczen przychodzacych//

		(*findkoralik(killed, Born1, Born2, Born3)).first_incoming = (*findkoralik(killed, Killed1, Killed2, Killed3)).first_incoming;
		(*findkoralik(killed, Killed1, Killed2, Killed3)).first_incoming = NULL;
